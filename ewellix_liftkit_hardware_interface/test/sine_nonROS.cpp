...
/**
 * Signal handler for ctrl-C, needed to help turn motors off later.
 */
...
/**
 * Loads parameters from ewellix_liftkit_parameters.yaml
 */
...
/**
 * Updates Gnuplot with new values and graph in real time.
 */
...
int main() {
    try {
        ...
        // Streams movement commands at 45 Hz
        while (!shutdown_requested) {
            ...
            // Sequential logic for independent actuator movement
            if (extending) {
                // Bottom extends first, then top
                ...
                // Top retracts first, then bottom
